...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Hier würde normalerweise ein API-Aufruf zur Authentifizierung erfolgen
      // Für die Demo simulieren wir einen erfolgreichen Login
        ...
        <div className="relative p-6">
          ...
          <div className="flex flex-col items-center mt-12 mb-8">
            ...
            <p className="text-gray-500 text-center text-sm mt-1">
              Melde dich an, um deine berufliche Reise fortzusetzen
            </p>
          </div>
              ...
              <div className="text-center space-y-3 mt-4">
                ...
                <div>
                  <span className="text-sm text-gray-500">
                    Noch kein Konto?{" "}
                    <Link href="/register" className="text-stone-600 hover:text-stone-700 font-medium">
                      Jetzt registrieren
                    </Link>
                  </span>
                </div>
